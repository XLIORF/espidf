...
typedef enum {
    ...
    /** Input device events*/
    LV_EVENT_PRESSED,             /**<1 The object has been pressed*/
    LV_EVENT_PRESSING,            /**<2 The object is being pressed (called continuously while pressing)*/
    LV_EVENT_PRESS_LOST,          /**<3 The object is still being pressed but slid cursor/finger off of the object */
    LV_EVENT_SHORT_CLICKED,       /**<4 The object was pressed for a short period of time, then released it. Not called if scrolled.*/
    LV_EVENT_LONG_PRESSED,        /**<5 Object has been pressed for at least `long_press_time`.  Not called if scrolled.*/
    LV_EVENT_LONG_PRESSED_REPEAT, /**<6 Called after `long_press_time` in every `long_press_repeat_time` ms.  Not called if scrolled.*/
    LV_EVENT_CLICKED,             /**<7 Called on release if not scrolled (regardless to long press)*/
    LV_EVENT_RELEASED,            /**<8 Called in every cases when the object has been released*/
    LV_EVENT_SCROLL_BEGIN,        /**<9 Scrolling begins*/
    LV_EVENT_SCROLL_END,          /**<10 Scrolling ends*/
    LV_EVENT_SCROLL,              /**<11 Scrolling*/
    LV_EVENT_GESTURE,             /**<12 A gesture is detected. Get the gesture with `lv_indev_get_gesture_dir(lv_indev_get_act());` */
    LV_EVENT_KEY,                 /**<13 A key is sent to the object. Get the key with `lv_indev_get_key(lv_indev_get_act());`*/
    LV_EVENT_FOCUSED,             /**<14 The object is focused*/
    LV_EVENT_DEFOCUSED,           /**<15 The object is defocused*/
    LV_EVENT_LEAVE,               /**<16 The object is defocused but still selected*/
    LV_EVENT_HIT_TEST,            /**<17 Perform advanced hit-testing*/

    /** Drawing events*/
    LV_EVENT_COVER_CHECK,        /**<18 Check if the object fully covers an area. The event parameter is `lv_cover_check_info_t *`.*/
    LV_EVENT_REFR_EXT_DRAW_SIZE, /**<19 Get the required extra draw area around the object (e.g. for shadow). The event parameter is `lv_coord_t *` to store the size.*/
    LV_EVENT_DRAW_MAIN_BEGIN,    /**<20 Starting the main drawing phase*/
    LV_EVENT_DRAW_MAIN,          /**<21 Perform the main drawing*/
    LV_EVENT_DRAW_MAIN_END,      /**<22 Finishing the main drawing phase*/
    LV_EVENT_DRAW_POST_BEGIN,    /**<23 Starting the post draw phase (when all children are drawn)*/
    LV_EVENT_DRAW_POST,          /**<24 Perform the post draw phase (when all children are drawn)*/
    ...
    LV_EVENT_DRAW_PART_END,      /**<27 Finishing to draw a part. The event parameter is `lv_obj_draw_dsc_t *`. */

    /** Special events*/
    LV_EVENT_VALUE_CHANGED,       /**<28 The object's value has changed (i.e. slider moved)*/
    LV_EVENT_INSERT,              /**<29 A text is inserted to the object. The event data is `char *` being inserted.*/
    LV_EVENT_REFRESH,             /**<30 Notify the object to refresh something on it (for the user)*/
    LV_EVENT_READY,               /**<31 A process has finished*/
    LV_EVENT_CANCEL,              /**<32 A process has been cancelled */

    /** Other events*/
    LV_EVENT_DELETE,              /**<33 Object is being deleted*/
    LV_EVENT_CHILD_CHANGED,       /**<34 Child was removed, added, or its size, position were changed */
    LV_EVENT_CHILD_CREATED,       /**<35 Child was created, always bubbles up to all parents*/
    LV_EVENT_CHILD_DELETED,       /**<36 Child was deleted, always bubbles up to all parents*/
    LV_EVENT_SCREEN_UNLOAD_START, /**<37 A screen unload started, fired immediately when scr_load is called*/
    LV_EVENT_SCREEN_LOAD_START,   /**<38 A screen load started, fired when the screen change delay is expired*/
    LV_EVENT_SCREEN_LOADED,       /**<39 A screen was loaded*/
    LV_EVENT_SCREEN_UNLOADED,     /**<40 A screen was unloaded*/
    LV_EVENT_SIZE_CHANGED,        /**<41 Object coordinates/size have changed*/
    LV_EVENT_STYLE_CHANGED,       /**<42 Object's style has changed*/
    LV_EVENT_LAYOUT_CHANGED,      /**<43 The children position has changed due to a layout recalculation*/
    LV_EVENT_GET_SELF_SIZE,       /**<44 Get the internal size of a widget*/
